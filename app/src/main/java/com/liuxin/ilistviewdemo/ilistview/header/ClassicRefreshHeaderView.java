package com.liuxin.ilistviewdemo.ilistview.header;
...
import com.liuxin.ilistviewdemo.ilistview.RefreshTrigger;
...
public class ClassicRefreshHeaderView extends RelativeLayout implements RefreshTrigger {
    ...
    public ClassicRefreshHeaderView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        inflate(context, R.layout.layout_ilistview_classic_refresh_header_view, this);
